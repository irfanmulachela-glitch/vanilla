...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "vanilla exporter USA",
    "vanilla supplier Los Angeles",
    "vanilla beans Chicago",
    "vanilla paste manufacturer USA",
  ],
  alternates: {
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: "DHL & FedEx shipping",
                },
                {
                  icon: Globe,
                  title: "USA Coverage",
                  desc: "East & West coast",
                },
                {
                  icon: Package,
                  title: "MOQ 25kg",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Fast Shipping",
                description:
                  "3-5 day delivery to any US city. DHL and FedEx express shipping available.",
              },
              {
                icon: FileCheck,
      ...
      <section className="py-16 lg:py-24 bg-[#F8F6F2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#2C2518] mb-12 text-center">
            Vanilla Products for US Market
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: "New York, USA", url: "/suppliers/new-york" },
            ])
          ),
        }}
      />
