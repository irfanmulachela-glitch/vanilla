      ...
      <section className="bg-white border-b border-[#E5E0D8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-[#D8D3C9]">
              <Image
                src={product.image}
                alt={product.name}
                fill
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div key={stat.label} className="bg-[#F8F6F2] p-4 rounded-xl border border-[#E5E0D8]">
